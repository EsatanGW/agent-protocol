...
_(none — Sprint 2 closed; Sprint 3 scope is non-Claude-Code multi-agent enforcement + adapter selftests + adoption anti-metrics + security-sensitive manifest example.)_
